            ...
            <main>
                ...
                <section className="bg-white mt-10 mb-20">
                    <div className="container px-6 py-10 mx-auto">
                        <h1 className="text-2xl font-semibold text-gray-800 capitalize lg:text-3xl">Why<br /> Choose Us?</h1>
                        ...
                        <div className="mt-8 xl:mt-12 lg:flex lg:items-center">
                            <div className="grid w-full grid-cols-1 gap-8 lg:w-1/2 xl:gap-8 md:grid-cols-2">
                                <div className="space-y-3 border rounded-lg p-6 borer-black shadow-lg transition-all hover:translate-x-2 hover:shadow-xl md:-translate-y-4">
